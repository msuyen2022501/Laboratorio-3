...
import { getCompanies, getCompaniesSorted, getCompaniesSortedDesc, getExcel, postCompany, editCompany, postCompaniesByTrayectoria, postCompaniesByCategoria, postCompaniesByNivelImpacto } from "./company.controller.js";
...
router.get('/a-z', validarJWT, getCompaniesSorted); 

router.get('/z-a', validarJWT, getCompaniesSortedDesc); 

router.get('/excel', validarJWT, getExcel)
